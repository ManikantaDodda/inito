    ...
    return (
        <section class="why-inito-is-smarter-way">
            <section class="why-measure-progesterone">
                <img alt="calender" class="blue-calendar" src="https://cdn.inito.com/inito_website/blue_calendar.png" />
                ...
                <div class="doctor-review-source">
                    ...
                    <div class="doctor">
                        <img alt="doctor" class="doctor-image" src="https://cdn.inito.com/inito_website/doc_testimonial_wagner.jpg" />
            ...
            <section class="blue-background">
                ...
                <section class="left-card">
                    <div class="text-content">
                        <h1>Get charts and actual <span class="image_as_underline">values</span> of your <span class="inline-image">hormones
                            <img alt="star" class="homepage-4-star" src="https://cdn.inito.com/inito_website/homepage_4_star.png" /></span></h1>
                        <div>
                        ...
                        <a class="small-view-button" href="/buy-now">GET THE INITO KIT</a>
                    </div>
                ...
                <section class="right-card">
                    <div class="text-content">
                        ...
                        <a class="button" href="/buy-now">Get the Inito Kit</a>
                    </div>
